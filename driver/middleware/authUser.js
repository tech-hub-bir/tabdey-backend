...
/**
 * Restricts access to the resource owner (req.params.user_id) or an admin/finance role.
 * Must run after authUser and after a validUserId param check.
 */
function requireSelfOrAdmin(req, res, next) {
  const paramUserId = Number(req.params.user_id);
